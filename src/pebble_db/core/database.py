...
from core.table import PebbleTable, PebbleTableFactory
...
class PebbleDatabase:
    ...
    def _insert_in_bulk(
        ...
        for entry in entries:
            ...
            result.append(
                self._insert(entry=entry, is_bulk_operation=True, timestamp=timestamp)
            )
    ...
    def create_table(
        ...
        table: PebbleTable = PebbleTableFactory.create(
            database=self.name,
            data=data,
